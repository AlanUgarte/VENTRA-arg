    ...
    <div style={{ fontFamily: 'var(--font-hanken), system-ui, sans-serif', background: '#fbf8f1', color: '#1a1c1a', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: 'clamp(32px,5vw,64px) clamp(18px,4vw,40px)' }}>
        ...
        {[
          ...
          { title: '4. Suscripción y pagos', body: 'El plan disponible es Plan Completo ($24.990/mes), que incluye todas las funciones y hasta 3 usuarios (1 dueño + 2 cajeros). Los pagos se procesan mensualmente a través de Mercado Pago. Podés cancelar en cualquier momento; el acceso se mantiene hasta el fin del período pagado.' },
